...
class FamilyBagFunctionsTest {
    ...
    fun testContainsAll() {
        ...
        assertFalse(testFamily.containsAll(listOf(Entity(2))))
        assertTrue(testFamily.containsAll(listOf(Entity(1))))
    ...
    fun testGroupByTo() {
        val expected1 = mapOf(
            ...
            2 to mutableEntityBagOf(Entity(2))
        )
        val expected2 = mapOf(0 to listOf(3), 1 to listOf(3), 2 to listOf(3))

        val actual = testFamily.groupByTo(mutableMapOf(2 to mutableEntityBagOf(Entity(2)))) { it.id }
