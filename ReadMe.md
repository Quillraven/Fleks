...
[![Maven](https://img.shields.io/badge/Maven-1.5--JVM-success.svg)](https://search.maven.org/artifact/io.github.quillraven.fleks/Fleks/1.5-JVM/jar)
...
```kotlin
implementation 'io.github.quillraven.fleks:Fleks:1.5-JVM'
```
