...
[![Maven](https://img.shields.io/badge/Maven-1.3--KMP-success.svg)](https://search.maven.org/artifact/io.github.quillraven.fleks/Fleks/1.3-KMP/jar)
...
```kotlin
implementation 'io.github.quillraven.fleks:Fleks:1.3-KMP'
```
